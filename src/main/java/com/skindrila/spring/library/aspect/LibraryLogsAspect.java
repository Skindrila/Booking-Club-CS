...
public class LibraryLogsAspect {
	...
	@Pointcut("execution(* com.skindrila.spring.library.service.LibraryServiceImpl.reserveBook(..))")
	public void reserveBook() {}
	
	@Pointcut("execution(* com.skindrila.spring.library.service.LibraryServiceImpl.borrowBook(..))")
	public void borrowBook() {}
	
	@Pointcut("execution(* com.skindrila.spring.library.service.LibraryServiceImpl.returnBook(..))")
