package com.skindrila.spring.library.aspect;
...
public class UserLogsAspect {
	...
	@Pointcut("execution(* com.skindrila.spring.library.dao.UserDAOImpl.saveUser(..))")
	public void saveUser() {}
	
	@Pointcut("execution(* com.skindrila.spring.library.dao.UserDAOImpl.enableUser(..))")
	public void enableUser() {}
	
	@Pointcut("execution(* com.skindrila.spring.library.dao.UserDAOImpl.disableUser(..))")
	public void disableUser() {}
	
	@Pointcut("execution(* com.skindrila.spring.library.dao.UserDAOImpl.updateUser(..))")
